=head1 ActivePerl 825 -- Release Notes

Welcome, and thank you for downloading ActivePerl.  This release
corresponds to Perl version 5.8.9.
...
Windows XP, Server 2003, Vista, Server 2008 (x86 and x64)
...
Running C<ppm> without arguments now bring up a graphical user interface;
there is a separate program called C<ppm-shell> that gives you an interface
...
The installer cannot create IIS script mappings on Windows Vista and
Windows Server 2008.
