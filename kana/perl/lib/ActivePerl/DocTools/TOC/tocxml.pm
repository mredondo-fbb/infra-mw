...
sub boiler_header {
    ...
    my $version = $] < 5.008 ? "5.6" : "5.8";
    $version = "5.10" if $] >= 5.010;
    return <<"HERE";
...
sub boiler_links {
    ...
    $text .= _page("changes-510.html", "ActivePerl 5.10 Change Log")
	if -e "$ActivePerl::DocTools::TOC::dirbase/changes-510.html";
...
sub PerlEx_links {
    ...
    $text .= _page("", "Installation");
    $text .= library_indent_open();
    $text .= _page("PerlEx/InstallationRequirements.html", "Installation Requirements");
    $text .= _page("PerlEx/InstallationDetails.html", "Installation Details");
    $text .= library_indent_close();
