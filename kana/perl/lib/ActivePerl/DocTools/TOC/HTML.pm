...
<ul>
  ...
  <li><a class="doc" href="changes-56.html">ActivePerl 5.6 Change Log</a></li>
  <li><a class="doc" href="changes-58.html">ActivePerl 5.8 Change Log</a></li>
HERE
  $retval .= <<HERE if -e "$ActivePerl::DocTools::TOC::dirbase/changes-510.html";
  <li><a class="doc" href="changes-510.html">ActivePerl 5.10 Change Log</a></li>
HERE
