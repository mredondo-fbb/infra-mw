    ...
    <nc:subheadings>
      <rdf:Seq>
        <rdf:li>
          ...
          <rdf:Description nc:name="ActivePerl 5.6 Change Log" nc:link="ActivePerl/changes-56.html"/>
          <rdf:Description nc:name="ActivePerl 5.8 Change Log" nc:link="ActivePerl/changes-58.html"/>
          <rdf:Description nc:name="ActivePerl 5.10 Change Log" nc:link="ActivePerl/changes-510.html"/>
        </rdf:li>
      </rdf:Seq>
    </nc:subheadings>
  </rdf:Description>
