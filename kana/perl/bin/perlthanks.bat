...
my $config_tag1 = 'v5.8.9 - Sun Dec 14 21:07:19 2008';

my $patchlevel_date = 1229286760;
my $patch_tags = '+ACTIVEPERL_LOCAL_PATCHES_ENTRY +Iin_load_module +Avoid +Less +Rearrange +Partly +31188 +29732 +27527,29868 +26379 ';
my @patches = (
